...
make_plots <- function(model, data_train_fold, data_test_fold) {
    ...
    par(mar = c(5, 6, 4, 1) + .1)
    p1 <- plot(predict(model, data_train_fold), data_train_fold$num_clicks, xlab = "Predictions on training data", ylab = "Number of Clicks", cex.axis = 3, cex.lab = 3, col = rgb(red = 0, green = 0, blue = 0, alpha = 0.3), pch = 16, axes = FALSE)
    axis(1, cex.axis = 2)
    axis(2, cex.axis = 2)
    p1 + theme(
    ...
    par(mar = c(5, 6, 4, 1) + .1)
    p2 <- plot(predict(model, data_test_fold), data_test_fold$num_clicks, xlab = "Predictions on test data", ylab = "Number of Clicks", cex.axis = 3, cex.lab = 3, col = rgb(red = 0, green = 0, blue = 0, alpha = 0.3), pch = 16, axes = FALSE)
    axis(1, cex.axis = 2)
    axis(2, cex.axis = 2)
    p2 + theme(
        plot.title = element_text(family = "serif", size = 16),
