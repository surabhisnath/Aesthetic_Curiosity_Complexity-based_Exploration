...
## Description: This script implements mixed effects models of complexity ratings on 27x27, semi-revealed patterns.
...
# Setup
{
  ...
  all_attention_failed = c('fafl6odp', 's7hnc00q', 'p60mbj11') # remove subjects who failed all attention checks
